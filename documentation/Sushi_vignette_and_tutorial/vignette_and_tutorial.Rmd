...
In the control wells, we calculate the absolute median deviation of each pool to the median log2 normalized value across the controls.

* We filter out pools where the absolute median deviation is greater than 2.

* Wells with more than 25% of pools exceeding this threshold are dropped.

* Pools that exceed this threshold in more than 25% of the wells of the PCR plate are dropped.
